...
return physicsGame.dom.call(null,"﷐'scoreValue").text(new_score__1969);
});
...
{var data_x__1983 = contact.GetFixtureA().GetBody().GetUserData();
var data_y__1984 = contact.GetFixtureB().GetBody().GetUserData();
...
}),cljs.core.Vector.fromArray([data_x__1983,data_y__1984]))))
...
return physicsGame.js_set.call(null,(new goog.global['Object']()),"﷐'PostSolve",physicsGame.empty_fn,"﷐'BeginContact",physicsGame.empty_fn,"﷐'EndContact",physicsGame.empty_fn,"﷐'PreSolve",(function (p1__1981_SHARP_,p2__1982_SHARP_){
return physicsGame.pre_solve.call(null,game,p1__1981_SHARP_,p2__1982_SHARP_);
}));
});
...
var gravity__1985 = physicsGame.v.call(null,0,10);
var doSleep__1986 = false;
var world__1987 = (new physicsGame.b2World(gravity__1985,doSleep__1986));

return world__1987;
});
physicsGame.create_game = (function create_game(canvas){
var twiceScale__1988 = cljs.core._STAR_.call(null,2,physicsGame.scale);

return physicsGame.init.call(null,physicsGame.set_contact_listener.call(null,cljs.core.atom.call(null,physicsGame.add_methods.call(null,cljs.core.ObjMap.fromObject(["﷐'center-x","﷐'center-y","﷐'world","﷐'canvas"],{"﷐'center-x":cljs.core._SLASH_.call(null,physicsGame.W,twiceScale__1988),"﷐'center-y":cljs.core._SLASH_.call(null,physicsGame.H,twiceScale__1988),"﷐'world":physicsGame.build_world.call(null),"﷐'canvas":canvas})))));
});
...
var shape__1989 = fixture.GetShape();
var transform__1990 = fixture.GetBody().GetTransform();

return cljs.core.not.call(null,shape__1989.TestPoint(transform__1990,vec));
});
physicsGame.delete_at = (function delete_at(game,x,y){
var mouse_vec__1991 = physicsGame.v.call(null,x,y);
var aabb__1992 = (new physicsGame.b2AABB());
var delta__1993 = 0.0010;
var callback__1995 = (function (f){
if(cljs.core.truth_((function (){var or__3576__auto____1994 = physicsGame.static_QMARK_.call(null,f);

if(cljs.core.truth_(or__3576__auto____1994))
{return or__3576__auto____1994;
} else
{return physicsGame.not_has_point_QMARK_.call(null,f,mouse_vec__1991);
}
})()))
{return true;
} else
...
aabb__1992.lowerBound.Set(cljs.core._.call(null,x,delta__1993),cljs.core._.call(null,y,delta__1993));
aabb__1992.upperBound.Set(cljs.core._PLUS_.call(null,x,delta__1993),cljs.core._PLUS_.call(null,y,delta__1993));
return cljs.core.deref.call(null,game).call(null,"﷐'world").QueryAABB(callback__1995,aabb__1992);
});
...
var game__1996 = physicsGame.create_game.call(null,physicsGame.get_canvas.call(null));

physicsGame.dom.call(null,"﷐'pause").click((function (){
return physicsGame.toggle_pause.call(null,game__1996);
}));
physicsGame.dom.call(null,"﷐'canvas").mousedown((function (e){
var o__1997 = physicsGame.dom.call(null,"﷐'canvas").offset();

physicsGame.on_click.call(null,game__1996,cljs.core._.call(null,e.pageX,o__1997.left),cljs.core._.call(null,e.pageY,o__1997.top));
return false;
}));
physicsGame.build_walls.call(null,game__1996);
return physicsGame.animate_world.call(null,game__1996);
});
