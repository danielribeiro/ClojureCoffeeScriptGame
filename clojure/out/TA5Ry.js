...
{return physicsGame.atom_set.call(null,game,"﷐'to-delete",cljs.core.conj.call(null,cljs.core.deref.call(null,game).call(null,"﷐'to-delete"),body__1983));
} else
{return null;
}
});
physicsGame.on_click = (function on_click(game,x,y){
if(cljs.core.truth_(physicsGame.not_paused_QMARK_))
{return game;
} else
...
return physicsGame.on_click.call(null,game__1984,cljs.core._.call(null,e.pageX,o__1985.left),cljs.core._.call(null,e.pageY,o__1985.top));
}));
