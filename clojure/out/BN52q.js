...
var type__1975 = cljs.core.rand_nth.call(null,cljs.core.Vector.fromArray(["﷐'circle","﷐'square","﷐'triangle"]));
var method__1976 = cljs.core.keyword.call(null,cljs.core.str.call(null,"create-",cljs.core.name.call(null,type__1975)));

return cljs.core.deref.call(null,game).call(null,method__1976).call(null,game,randomX__1974,randomY__1973,cljs.core.inc.call(null,cljs.core.rand.call(null)));
});
physicsGame.maybe_create_element = (function maybe_create_element(game){
var neg_probability__1977 = cljs.core._STAR_.call(null,0.97,Math.pow.call(null,0.95,cljs.core.deref.call(null,game).call(null,"﷐'speed")));

if(cljs.core.truth_(cljs.core._GT_.call(null,cljs.core.rand.call(null),neg_probability__1977)))
...
var domspeed__1978 = physicsGame.dom.call(null,"﷐'speedValue");

domspeed__1978.text(cljs.core.deref.call(null,game).call(null,"﷐'speed"));
return domspeed__1978.hide().slideDown();
});
...
var to_destroy__1979 = cljs.core.deref.call(null,game).call(null,"﷐'to-destroy");
var new_score__1980 = cljs.core._PLUS_.call(null,cljs.core.deref.call(null,game).call(null,"﷐'score"),cljs.core.count.call(null,to_destroy__1979));

var G__1981__1982 = cljs.core.seq.call(null,to_destroy__1979);

while(true){
if(cljs.core.truth_(G__1981__1982))
{var b__1983 = cljs.core.first.call(null,G__1981__1982);

cljs.core.deref.call(null,game).call(null,"﷐'world").DestroyBody(b__1983);
{
var G__1984 = cljs.core.next.call(null,G__1981__1982);
G__1981__1982 = G__1984;
continue;
}
} else
{}
...
physicsGame.atom_set.call(null,game,"﷐'to-destroy",cljs.core.Vector.fromArray([]),"﷐'score",new_score__1980);
return physicsGame.update_score.call(null,game);
});
physicsGame.do_tick = (function do_tick(game){
var w__1985 = cljs.core.deref.call(null,game).call(null,"﷐'world");
var missing_ticks__1986 = cljs.core.deref.call(null,game).call(null,"﷐'ticks-to-speed");

if(cljs.core.truth_(cljs.core._EQ_.call(null,1,missing_ticks__1986)))
{physicsGame.atom_set.call(null,game,"﷐'ticks-to-speed",physicsGame.speed_rate);
physicsGame.increment_speed.call(null,game);
} else
{physicsGame.atom_set.call(null,game,"﷐'ticks-to-speed",cljs.core.dec.call(null,missing_ticks__1986));
}
...
w__1985.Step(cljs.core._SLASH_.call(null,1,30),10,10);
w__1985.DrawDebugData();
return w__1985.ClearForces();
});
physicsGame.tick = (function tick(game){
if(cljs.core.truth_((function (){var and__3574__auto____1987 = cljs.core.deref.call(null,game).call(null,"﷐'game-over");
...
var debug_draw__1988 = (new physicsGame.b2DebugDraw());

var G__1989__1990 = debug_draw__1988;

G__1989__1990.SetSprite(cljs.core.deref.call(null,game).call(null,"﷐'canvas").getContext("2d"));
G__1989__1990.SetDrawScale(physicsGame.scale);
G__1989__1990.SetLineThickness(1.0);
G__1989__1990.SetFlags(physicsGame.b2DebugDraw.e_shapeBit);
G__1989__1990;
cljs.core.deref.call(null,game).call(null,"﷐'world").SetDebugDraw(debug_draw__1988);
...
var n__204__auto____1992 = 5;

var ___1993 = 0;

while(true){
if(cljs.core.truth_(cljs.core._LT_.call(null,___1993,n__204__auto____1992)))
{physicsGame.create_element.call(null,game);
{
var G__1994 = cljs.core.inc.call(null,___1993);
___1993 = G__1994;
continue;
}
} else
...
{var data_x__1997 = contact.GetFixtureA().GetBody().GetUserData();
var data_y__1998 = contact.GetFixtureB().GetBody().GetUserData();

if(cljs.core.truth_(cljs.core.some.call(null,(function (p1__1991_SHARP_){
return cljs.core._EQ_.call(null,p1__1991_SHARP_,"﷐'ceiling");
}),cljs.core.Vector.fromArray([data_x__1997,data_y__1998]))))
...
return physicsGame.js_set.call(null,(new goog.global['Object']()),"﷐'PostSolve",physicsGame.empty_fn,"﷐'BeginContact",physicsGame.empty_fn,"﷐'EndContact",physicsGame.empty_fn,"﷐'PreSolve",(function (p1__1995_SHARP_,p2__1996_SHARP_){
return physicsGame.pre_solve.call(null,game,p1__1995_SHARP_,p2__1996_SHARP_);
}));
});
...
var gravity__1999 = physicsGame.v.call(null,0,10);
var doSleep__2000 = false;
var world__2001 = (new physicsGame.b2World(gravity__1999,doSleep__2000));

return world__2001;
});
physicsGame.create_game = (function create_game(canvas){
var twiceScale__2002 = cljs.core._STAR_.call(null,2,physicsGame.scale);

return physicsGame.init.call(null,physicsGame.set_contact_listener.call(null,cljs.core.atom.call(null,physicsGame.add_methods.call(null,cljs.core.ObjMap.fromObject(["﷐'center-x","﷐'center-y","﷐'world","﷐'canvas"],{"﷐'center-x":cljs.core._SLASH_.call(null,physicsGame.W,twiceScale__2002),"﷐'center-y":cljs.core._SLASH_.call(null,physicsGame.H,twiceScale__2002),"﷐'world":physicsGame.build_world.call(null),"﷐'canvas":canvas})))));
});
...
var shape__2003 = fixture.GetShape();
var transform__2004 = fixture.GetBody().GetTransform();

return cljs.core.not.call(null,shape__2003.TestPoint(transform__2004,vec));
});
physicsGame.delete_at = (function delete_at(game,x,y){
var mouse_vec__2005 = physicsGame.v.call(null,x,y);
var aabb__2006 = (new physicsGame.b2AABB());
var delta__2007 = 0.0010;
var callback__2009 = (function (f){
if(cljs.core.truth_((function (){var or__3576__auto____2008 = physicsGame.static_QMARK_.call(null,f);

if(cljs.core.truth_(or__3576__auto____2008))
{return or__3576__auto____2008;
} else
{return physicsGame.not_has_point_QMARK_.call(null,f,mouse_vec__2005);
}
})()))
{return true;
} else
...
aabb__2006.lowerBound.Set(cljs.core._.call(null,x,delta__2007),cljs.core._.call(null,y,delta__2007));
aabb__2006.upperBound.Set(cljs.core._PLUS_.call(null,x,delta__2007),cljs.core._PLUS_.call(null,y,delta__2007));
return cljs.core.deref.call(null,game).call(null,"﷐'world").QueryAABB(callback__2009,aabb__2006);
});
...
return physicsGame.each_body.call(null,game,(function (p1__2010_SHARP_){
if(cljs.core.truth_(physicsGame.static_body_QMARK_.call(null,p1__2010_SHARP_)))
{return null;
} else
{return cljs.core.deref.call(null,game).call(null,"﷐'world").DestroyBody(p1__2010_SHARP_);
}
}));
});
...
var game__2011 = physicsGame.create_game.call(null,physicsGame.get_canvas.call(null));

physicsGame.dom.call(null,"﷐'pause").click((function (){
return physicsGame.toggle_pause.call(null,game__2011);
}));
physicsGame.dom.call(null,"﷐'restart").click((function (){
return physicsGame.restart.call(null,game__2011);
}));
physicsGame.dom.call(null,"﷐'canvas").mousedown((function (e){
var o__2012 = physicsGame.dom.call(null,"﷐'canvas").offset();

physicsGame.on_click.call(null,game__2011,cljs.core._.call(null,e.pageX,o__2012.left),cljs.core._.call(null,e.pageY,o__2012.top));
return false;
}));
physicsGame.build_walls.call(null,game__2011);
return physicsGame.animate_world.call(null,game__2011);
});
