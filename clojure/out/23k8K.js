...
return domspeed__1967.hide().slide();
});
physicsGame.do_tick = (function do_tick(game){
var w__1969 = cljs.core.deref.call(null,game).call(null,"﷐'world");
var speed__1970 = cljs.core.deref.call(null,game).call(null,"﷐'ticks-to-speed");

if(cljs.core.truth_(cljs.core._EQ_.call(null,1,speed__1970)))
{physicsGame.atom_set.call(null,game,"﷐'ticks-to-speed",physicsGame.speed_rate);
physicsGame.increment_speed.call(null,game);
} else
{physicsGame.atom_set.call(null,game,"﷐'ticks-to-speed",cljs.core.dec.call(null,speed__1970));
}
