...
var speed__1968 = cljs.core.deref.call(null,game).call(null,"﷐'speed");

physicsGame.atom_set.call(null,game,"﷐'speed",cljs.core.inc.call(null,speed__1968));
domspeed__1967.text(speed__1968);
return domspeed__1967.hide().slideDown();
});
physicsGame.do_tick = (function do_tick(game){
var w__1969 = cljs.core.deref.call(null,game).call(null,"﷐'world");
var missing_ticks__1970 = cljs.core.deref.call(null,game).call(null,"﷐'ticks-to-speed");

if(cljs.core.truth_(cljs.core._EQ_.call(null,1,missing_ticks__1970)))
{physicsGame.atom_set.call(null,game,"﷐'ticks-to-speed",physicsGame.speed_rate);
physicsGame.increment_speed.call(null,game);
} else
{physicsGame.atom_set.call(null,game,"﷐'ticks-to-speed",cljs.core.dec.call(null,missing_ticks__1970));
}
physicsGame.p.call(null,"now its tics are :",cljs.core.deref.call(null,game).call(null,"﷐'ticks-to-speed"));
physicsGame.maybe_create_element.call(null,game);
w__1969.Step(cljs.core._SLASH_.call(null,1,30),10,10);
w__1969.DrawDebugData();
return w__1969.ClearForces();
});
physicsGame.tick = (function tick(game){
if(cljs.core.truth_((function (){var and__3574__auto____1971 = cljs.core.deref.call(null,game).call(null,"﷐'game-over");
...
var debug_draw__1972 = (new physicsGame.b2DebugDraw());

var G__1973__1974 = debug_draw__1972;

G__1973__1974.SetSprite(cljs.core.deref.call(null,game).call(null,"﷐'canvas").getContext("2d"));
G__1973__1974.SetDrawScale(physicsGame.scale);
G__1973__1974.SetLineThickness(1.0);
G__1973__1974.SetFlags(physicsGame.b2DebugDraw.e_shapeBit);
G__1973__1974;
cljs.core.deref.call(null,game).call(null,"﷐'world").SetDebugDraw(debug_draw__1972);
...
{var data_x__1978 = contact.GetFixtureA().GetBody().GetUserData();
var data_y__1979 = contact.GetFixtureB().GetBody().GetUserData();

if(cljs.core.truth_(cljs.core.some.call(null,(function (p1__1975_SHARP_){
return cljs.core._EQ_.call(null,p1__1975_SHARP_,"﷐'ceiling");
}),cljs.core.Vector.fromArray([data_x__1978,data_y__1979]))))
...
return physicsGame.js_set.call(null,(new goog.global['Object']()),"﷐'PostSolve",physicsGame.empty_fn,"﷐'BeginContact",physicsGame.empty_fn,"﷐'EndContact",physicsGame.empty_fn,"﷐'PreSolve",(function (p1__1976_SHARP_,p2__1977_SHARP_){
return physicsGame.pre_solve.call(null,game,p1__1976_SHARP_,p2__1977_SHARP_);
}));
});
...
var gravity__1980 = physicsGame.v.call(null,0,10);
var doSleep__1981 = false;
var world__1982 = (new physicsGame.b2World(gravity__1980,doSleep__1981));

return world__1982;
});
physicsGame.create_game = (function create_game(canvas){
var twiceScale__1983 = cljs.core._STAR_.call(null,2,physicsGame.scale);

return physicsGame.init.call(null,physicsGame.set_contact_listener.call(null,cljs.core.atom.call(null,physicsGame.add_methods.call(null,cljs.core.ObjMap.fromObject(["﷐'center-x","﷐'center-y","﷐'world","﷐'canvas"],{"﷐'center-x":cljs.core._SLASH_.call(null,physicsGame.W,twiceScale__1983),"﷐'center-y":cljs.core._SLASH_.call(null,physicsGame.H,twiceScale__1983),"﷐'world":physicsGame.build_world.call(null),"﷐'canvas":canvas})))));
});
