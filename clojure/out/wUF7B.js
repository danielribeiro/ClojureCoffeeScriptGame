...
return physicsGame.p.call(null,"tick");
});
physicsGame.animate_world = (function animate_world(game){
var debug_draw__1963 = (new physicsGame.b2DebugDraw());

var G__1964__1965 = physicsGame.debug_draw;

G__1964__1965.SetSprite(game.call(null,"﷐'canvas").getConext("2d"));
G__1964__1965.SetDrawScale(physicsGame.scale);
G__1964__1965.SetLineThickness(1.0);
G__1964__1965.SetFlags(physicsGame.b2DebugDraw.e_shapeBit);
G__1964__1965;
game.call(null,"﷐'world").SetDebugDraw(physicsGame.debugDraw);
...
var game__1966 = physicsGame.create_game.call(null,physicsGame.get_canvas.call(null));

physicsGame.build_walls.call(null,game__1966);
return physicsGame.animate_world.call(null,game__1966);
});
