...
return wall.call(null,game,game.dimensions,x,y,null);
});
...
game.fix_def.shape.SetAsBox(width,height);
game.js_set.call(null,game.body_def,"﷐'userData",user_data,"﷐'type",game.b2Body.b2_staticBody);
return game.create.call(null,game,game.body_def,game.fix_def);
});
...
game.p.call(null,game.create_fixture.call(null));
return game.p.call(null,game.create_body.call(null,0,2));
});
