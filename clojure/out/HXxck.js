...
var w__1968 = cljs.core.deref.call(null,game).call(null,"﷐'world");
var missing_ticks__1969 = cljs.core.deref.call(null,game).call(null,"﷐'ticks-to-speed");

if(cljs.core.truth_(cljs.core._EQ_.call(null,1,missing_ticks__1969)))
{physicsGame.atom_set.call(null,game,"﷐'ticks-to-speed",physicsGame.speed_rate);
physicsGame.increment_speed.call(null,game);
} else
{physicsGame.atom_set.call(null,game,"﷐'ticks-to-speed",cljs.core.dec.call(null,missing_ticks__1969));
}
physicsGame.maybe_create_element.call(null,game);
w__1968.Step(cljs.core._SLASH_.call(null,1,30),10,10);
w__1968.DrawDebugData();
return w__1968.ClearForces();
});
physicsGame.tick = (function tick(game){
if(cljs.core.truth_((function (){var and__3574__auto____1970 = cljs.core.deref.call(null,game).call(null,"﷐'game-over");
...
{var data_x__1977 = contact.GetFixtureA().GetBody().GetUserData();
var data_y__1978 = contact.GetFixtureB().GetBody().GetUserData();

if(cljs.core.truth_(cljs.core.some.call(null,(function (p1__1974_SHARP_){
return cljs.core._EQ_.call(null,p1__1974_SHARP_,"﷐'ceiling");
}),cljs.core.Vector.fromArray([data_x__1977,data_y__1978]))))
...
return physicsGame.js_set.call(null,(new goog.global['Object']()),"﷐'PostSolve",physicsGame.empty_fn,"﷐'BeginContact",physicsGame.empty_fn,"﷐'EndContact",physicsGame.empty_fn,"﷐'PreSolve",(function (p1__1975_SHARP_,p2__1976_SHARP_){
return physicsGame.pre_solve.call(null,game,p1__1975_SHARP_,p2__1976_SHARP_);
}));
});
...
var gravity__1979 = physicsGame.v.call(null,0,10);
var doSleep__1980 = false;
var world__1981 = (new physicsGame.b2World(gravity__1979,doSleep__1980));

return world__1981;
});
physicsGame.create_game = (function create_game(canvas){
var twiceScale__1982 = cljs.core._STAR_.call(null,2,physicsGame.scale);

return physicsGame.init.call(null,physicsGame.set_contact_listener.call(null,cljs.core.atom.call(null,physicsGame.add_methods.call(null,cljs.core.ObjMap.fromObject(["﷐'center-x","﷐'center-y","﷐'world","﷐'canvas"],{"﷐'center-x":cljs.core._SLASH_.call(null,physicsGame.W,twiceScale__1982),"﷐'center-y":cljs.core._SLASH_.call(null,physicsGame.H,twiceScale__1982),"﷐'world":physicsGame.build_world.call(null),"﷐'canvas":canvas})))));
});
...
return cljs.core._EQ_.call(null,fixture.GetBody().GetType(),physicsGame.b2Body.b2_staticBody);
});
physicsGame.not_has_point_QMARK_ = (function not_has_point_QMARK_(fixture,vec){
var shape__1983 = fixture.GetShape();
var transform__1984 = fixture.GetBody().GetTransform();

return cljs.core.not.call(null,shape__1983.TestPoint(transform__1984,vec));
});
physicsGame.delete_at = (function delete_at(game,x,y){
var mouse_vec__1985 = physicsGame.v.call(null,x,y);
var aabb__1986 = (new physicsGame.b2AABB());
var delta__1987 = 0.0010;

aabb__1986.lowerBound.Set(cljs.core._.call(null,x,delta__1987),cljs.core._.call(null,y,delta__1987));
aabb__1986.upperBound.Set(cljs.core._PLUS_.call(null,x,delta__1987),cljs.core._PLUS_.call(null,y,delta__1987));
physicsGame.letfn_STAR_.call(null,cljs.core.Vector.fromArray([physicsGame.callback,(function callback(f){
if(cljs.core.truth_((function (){var or__3576__auto____1988 = physicsGame.static_QMARK_.call(null,f);

if(cljs.core.truth_(or__3576__auto____1988))
{return or__3576__auto____1988;
} else
{return physicsGame.not_has_point_QMARK_.call(null,f,mouse_vec__1985);
}
})()))
{return true;
} else
...
})]),cljs.core.deref.call(null,game).call(null,"﷐'world").QueryAABB(physicsGame.callback,aabb__1986));
return physicsGame.p.call(null,"to-delete is now",cljs.core.deref.call(null,game).call(null,"﷐'to-destroy"));
});
...
var game__1989 = physicsGame.create_game.call(null,physicsGame.get_canvas.call(null));

physicsGame.dom.call(null,"﷐'pause").click((function (){
return physicsGame.toggle_pause.call(null,game__1989);
}));
physicsGame.dom.call(null,"﷐'canvas").mousedown((function (e){
var o__1990 = physicsGame.dom.call(null,"﷐'canvas").offset();

physicsGame.on_click.call(null,game__1989,cljs.core._.call(null,e.pageX,o__1990.left),cljs.core._.call(null,e.pageY,o__1990.top));
return false;
}));
physicsGame.build_walls.call(null,game__1989);
return physicsGame.animate_world.call(null,game__1989);
});
