...
fixture__1965.shape.SetAxBox(size,size);
...
var randomY__1966 = cljs.core._SLASH_.call(null,cljs.core._STAR_.call(null,physicsGame.H,cljs.core._PLUS_.call(null,0.2,cljs.core._STAR_.call(null,0.4,cljs.core.rand.call(null)))),physicsGame.scale);
var randomX__1967 = cljs.core._SLASH_.call(null,cljs.core._PLUS_.call(null,25,cljs.core._STAR_.call(null,cljs.core.rand.call(null),cljs.core._.call(null,physicsGame.W,50))),physicsGame.scale);

return physicsGame.create_square.call(null,game,randomX__1967,randomY__1966,cljs.core.inc.call(null,cljs.core.rand.call(null)));
});
physicsGame.maybe_create_element = (function maybe_create_element(game){
var neg_probability__1968 = cljs.core._STAR_.call(null,0.97,Math.pow.call(null,0.95,cljs.core.deref.call(null,game).call(null,"﷐'speed")));

if(cljs.core.truth_(cljs.core._GT_.call(null,cljs.core.rand.call(null),neg_probability__1968)))
...
var domspeed__1969 = physicsGame.dom.call(null,"﷐'speedValue");

domspeed__1969.text(cljs.core.deref.call(null,game).call(null,"﷐'speed"));
return domspeed__1969.hide().slideDown();
});
...
var to_destroy__1970 = cljs.core.deref.call(null,game).call(null,"﷐'to-destroy");
var new_score__1971 = cljs.core._PLUS_.call(null,cljs.core.deref.call(null,game).call(null,"﷐'score"),cljs.core.count.call(null,to_destroy__1970));

var G__1972__1973 = cljs.core.seq.call(null,to_destroy__1970);

while(true){
if(cljs.core.truth_(G__1972__1973))
{var b__1974 = cljs.core.first.call(null,G__1972__1973);

cljs.core.deref.call(null,game).call(null,"﷐'world").DestroyBody(b__1974);
{
var G__1975 = cljs.core.next.call(null,G__1972__1973);
G__1972__1973 = G__1975;
continue;
}
} else
{}
...
physicsGame.atom_set.call(null,game,"﷐'to-destroy",cljs.core.Vector.fromArray([]),"﷐'score",new_score__1971);
return physicsGame.update_score.call(null,game);
});
physicsGame.do_tick = (function do_tick(game){
var w__1976 = cljs.core.deref.call(null,game).call(null,"﷐'world");
var missing_ticks__1977 = cljs.core.deref.call(null,game).call(null,"﷐'ticks-to-speed");

if(cljs.core.truth_(cljs.core._EQ_.call(null,1,missing_ticks__1977)))
{physicsGame.atom_set.call(null,game,"﷐'ticks-to-speed",physicsGame.speed_rate);
physicsGame.increment_speed.call(null,game);
} else
{physicsGame.atom_set.call(null,game,"﷐'ticks-to-speed",cljs.core.dec.call(null,missing_ticks__1977));
}
...
w__1976.Step(cljs.core._SLASH_.call(null,1,30),10,10);
w__1976.DrawDebugData();
return w__1976.ClearForces();
});
physicsGame.tick = (function tick(game){
if(cljs.core.truth_((function (){var and__3574__auto____1978 = cljs.core.deref.call(null,game).call(null,"﷐'game-over");
...
var debug_draw__1979 = (new physicsGame.b2DebugDraw());

var G__1980__1981 = debug_draw__1979;

G__1980__1981.SetSprite(cljs.core.deref.call(null,game).call(null,"﷐'canvas").getContext("2d"));
G__1980__1981.SetDrawScale(physicsGame.scale);
G__1980__1981.SetLineThickness(1.0);
G__1980__1981.SetFlags(physicsGame.b2DebugDraw.e_shapeBit);
G__1980__1981;
cljs.core.deref.call(null,game).call(null,"﷐'world").SetDebugDraw(debug_draw__1979);
...
var n__204__auto____1983 = 5;

var ___1984 = 0;

while(true){
if(cljs.core.truth_(cljs.core._LT_.call(null,___1984,n__204__auto____1983)))
{physicsGame.create_element.call(null,game);
{
var G__1985 = cljs.core.inc.call(null,___1984);
___1984 = G__1985;
continue;
}
} else
...
{var data_x__1988 = contact.GetFixtureA().GetBody().GetUserData();
var data_y__1989 = contact.GetFixtureB().GetBody().GetUserData();

if(cljs.core.truth_(cljs.core.some.call(null,(function (p1__1982_SHARP_){
return cljs.core._EQ_.call(null,p1__1982_SHARP_,"﷐'ceiling");
}),cljs.core.Vector.fromArray([data_x__1988,data_y__1989]))))
...
return physicsGame.js_set.call(null,(new goog.global['Object']()),"﷐'PostSolve",physicsGame.empty_fn,"﷐'BeginContact",physicsGame.empty_fn,"﷐'EndContact",physicsGame.empty_fn,"﷐'PreSolve",(function (p1__1986_SHARP_,p2__1987_SHARP_){
return physicsGame.pre_solve.call(null,game,p1__1986_SHARP_,p2__1987_SHARP_);
}));
});
...
var gravity__1990 = physicsGame.v.call(null,0,10);
var doSleep__1991 = false;
var world__1992 = (new physicsGame.b2World(gravity__1990,doSleep__1991));

return world__1992;
});
physicsGame.create_game = (function create_game(canvas){
var twiceScale__1993 = cljs.core._STAR_.call(null,2,physicsGame.scale);

return physicsGame.init.call(null,physicsGame.set_contact_listener.call(null,cljs.core.atom.call(null,physicsGame.add_methods.call(null,cljs.core.ObjMap.fromObject(["﷐'center-x","﷐'center-y","﷐'world","﷐'canvas"],{"﷐'center-x":cljs.core._SLASH_.call(null,physicsGame.W,twiceScale__1993),"﷐'center-y":cljs.core._SLASH_.call(null,physicsGame.H,twiceScale__1993),"﷐'world":physicsGame.build_world.call(null),"﷐'canvas":canvas})))));
});
...
var shape__1994 = fixture.GetShape();
var transform__1995 = fixture.GetBody().GetTransform();

return cljs.core.not.call(null,shape__1994.TestPoint(transform__1995,vec));
});
physicsGame.delete_at = (function delete_at(game,x,y){
var mouse_vec__1996 = physicsGame.v.call(null,x,y);
var aabb__1997 = (new physicsGame.b2AABB());
var delta__1998 = 0.0010;
var callback__2000 = (function (f){
if(cljs.core.truth_((function (){var or__3576__auto____1999 = physicsGame.static_QMARK_.call(null,f);

if(cljs.core.truth_(or__3576__auto____1999))
{return or__3576__auto____1999;
} else
{return physicsGame.not_has_point_QMARK_.call(null,f,mouse_vec__1996);
}
})()))
{return true;
} else
...
aabb__1997.lowerBound.Set(cljs.core._.call(null,x,delta__1998),cljs.core._.call(null,y,delta__1998));
aabb__1997.upperBound.Set(cljs.core._PLUS_.call(null,x,delta__1998),cljs.core._PLUS_.call(null,y,delta__1998));
return cljs.core.deref.call(null,game).call(null,"﷐'world").QueryAABB(callback__2000,aabb__1997);
});
...
return physicsGame.each_body.call(null,game,(function (p1__2001_SHARP_){
if(cljs.core.truth_(physicsGame.static_body_QMARK_.call(null,p1__2001_SHARP_)))
{return null;
} else
{return cljs.core.deref.call(null,game).call(null,"﷐'world").DestroyBody(p1__2001_SHARP_);
}
}));
});
...
var game__2002 = physicsGame.create_game.call(null,physicsGame.get_canvas.call(null));

physicsGame.dom.call(null,"﷐'pause").click((function (){
return physicsGame.toggle_pause.call(null,game__2002);
}));
physicsGame.dom.call(null,"﷐'restart").click((function (){
return physicsGame.restart.call(null,game__2002);
}));
physicsGame.dom.call(null,"﷐'canvas").mousedown((function (e){
var o__2003 = physicsGame.dom.call(null,"﷐'canvas").offset();

physicsGame.on_click.call(null,game__2002,cljs.core._.call(null,e.pageX,o__2003.left),cljs.core._.call(null,e.pageY,o__2003.top));
return false;
}));
physicsGame.build_walls.call(null,game__2002);
return physicsGame.animate_world.call(null,game__2002);
});
