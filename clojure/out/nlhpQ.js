...
{physicsGame.dom.call(null,"﷐'gameOver").fadeIn();
}
...
{var data_x__1973 = contact.GetFixtureA().GetBody().GetUserData();
var data_y__1974 = contact.GetFixtureB().GetBody().GetUserData();
...
}),cljs.core.Vector.fromArray([data_x__1973,data_y__1974]))))
...
return physicsGame.js_set.call(null,(new goog.global['Object']()),"﷐'PostSolve",physicsGame.empty_fn,"﷐'BeginContact",physicsGame.empty_fn,"﷐'EndContact",physicsGame.empty_fn,"﷐'PreSolve",physicsGame.empty_fn);
});
...
var gravity__1975 = physicsGame.v.call(null,0,10);
var doSleep__1976 = false;
var world__1977 = (new physicsGame.b2World(gravity__1975,doSleep__1976));

return world__1977;
});
physicsGame.create_game = (function create_game(canvas){
var twiceScale__1978 = cljs.core._STAR_.call(null,2,physicsGame.scale);

return physicsGame.init.call(null,cljs.core.atom.call(null,physicsGame.set_contact_listener.call(null,physicsGame.add_methods.call(null,cljs.core.ObjMap.fromObject(["﷐'center-x","﷐'center-y","﷐'world","﷐'canvas"],{"﷐'center-x":cljs.core._SLASH_.call(null,physicsGame.W,twiceScale__1978),"﷐'center-y":cljs.core._SLASH_.call(null,physicsGame.H,twiceScale__1978),"﷐'world":physicsGame.build_world.call(null),"﷐'canvas":canvas})))));
});
...
var game__1979 = physicsGame.create_game.call(null,physicsGame.get_canvas.call(null));

physicsGame.dom.call(null,"﷐'pause").click((function (){
return physicsGame.toggle_pause.call(null,game__1979);
}));
physicsGame.build_walls.call(null,game__1979);
physicsGame.animate_world.call(null,game__1979);
return physicsGame.p.call(null,cljs.core.deref.call(null,game__1979));
});
