...
fixture__1964.shape.SetAsBox(size,size);
...
var fixture__1965 = physicsGame.create_fixture.call(null,(new physicsGame.b2PolygonShape()));
var vertices__1966 = cljs.core.Vector.fromArray([physicsGame.v.call(null,cljs.core._.call(null,size),0),physicsGame.v.call(null,size,0),physicsGame.v.call(null,0,cljs.core._STAR_.call(null,size,Math.sqrt.call(null,3)))]);

fixture__1965.shape.SetAsArray(vertices__1966);
return physicsGame.create.call(null,game,physicsGame.random_body.call(null,x,y),fixture__1965);
});
...
var randomY__1967 = cljs.core._SLASH_.call(null,cljs.core._STAR_.call(null,physicsGame.H,cljs.core._PLUS_.call(null,0.2,cljs.core._STAR_.call(null,0.4,cljs.core.rand.call(null)))),physicsGame.scale);
var randomX__1968 = cljs.core._SLASH_.call(null,cljs.core._PLUS_.call(null,25,cljs.core._STAR_.call(null,cljs.core.rand.call(null),cljs.core._.call(null,physicsGame.W,50))),physicsGame.scale);

return physicsGame.create_triangle.call(null,game,randomX__1968,randomY__1967,cljs.core.inc.call(null,cljs.core.rand.call(null)));
});
physicsGame.maybe_create_element = (function maybe_create_element(game){
var neg_probability__1969 = cljs.core._STAR_.call(null,0.97,Math.pow.call(null,0.95,cljs.core.deref.call(null,game).call(null,"﷐'speed")));

if(cljs.core.truth_(cljs.core._GT_.call(null,cljs.core.rand.call(null),neg_probability__1969)))
...
var domspeed__1970 = physicsGame.dom.call(null,"﷐'speedValue");

domspeed__1970.text(cljs.core.deref.call(null,game).call(null,"﷐'speed"));
return domspeed__1970.hide().slideDown();
});
...
var to_destroy__1971 = cljs.core.deref.call(null,game).call(null,"﷐'to-destroy");
var new_score__1972 = cljs.core._PLUS_.call(null,cljs.core.deref.call(null,game).call(null,"﷐'score"),cljs.core.count.call(null,to_destroy__1971));

var G__1973__1974 = cljs.core.seq.call(null,to_destroy__1971);

while(true){
if(cljs.core.truth_(G__1973__1974))
{var b__1975 = cljs.core.first.call(null,G__1973__1974);

cljs.core.deref.call(null,game).call(null,"﷐'world").DestroyBody(b__1975);
{
var G__1976 = cljs.core.next.call(null,G__1973__1974);
G__1973__1974 = G__1976;
continue;
}
} else
{}
...
physicsGame.atom_set.call(null,game,"﷐'to-destroy",cljs.core.Vector.fromArray([]),"﷐'score",new_score__1972);
return physicsGame.update_score.call(null,game);
});
physicsGame.do_tick = (function do_tick(game){
var w__1977 = cljs.core.deref.call(null,game).call(null,"﷐'world");
var missing_ticks__1978 = cljs.core.deref.call(null,game).call(null,"﷐'ticks-to-speed");

if(cljs.core.truth_(cljs.core._EQ_.call(null,1,missing_ticks__1978)))
{physicsGame.atom_set.call(null,game,"﷐'ticks-to-speed",physicsGame.speed_rate);
physicsGame.increment_speed.call(null,game);
} else
{physicsGame.atom_set.call(null,game,"﷐'ticks-to-speed",cljs.core.dec.call(null,missing_ticks__1978));
}
...
w__1977.Step(cljs.core._SLASH_.call(null,1,30),10,10);
w__1977.DrawDebugData();
return w__1977.ClearForces();
});
physicsGame.tick = (function tick(game){
if(cljs.core.truth_((function (){var and__3574__auto____1979 = cljs.core.deref.call(null,game).call(null,"﷐'game-over");
...
var debug_draw__1980 = (new physicsGame.b2DebugDraw());

var G__1981__1982 = debug_draw__1980;

G__1981__1982.SetSprite(cljs.core.deref.call(null,game).call(null,"﷐'canvas").getContext("2d"));
G__1981__1982.SetDrawScale(physicsGame.scale);
G__1981__1982.SetLineThickness(1.0);
G__1981__1982.SetFlags(physicsGame.b2DebugDraw.e_shapeBit);
G__1981__1982;
cljs.core.deref.call(null,game).call(null,"﷐'world").SetDebugDraw(debug_draw__1980);
...
var n__204__auto____1984 = 5;

var ___1985 = 0;

while(true){
if(cljs.core.truth_(cljs.core._LT_.call(null,___1985,n__204__auto____1984)))
{physicsGame.create_element.call(null,game);
{
var G__1986 = cljs.core.inc.call(null,___1985);
___1985 = G__1986;
continue;
}
} else
...
{var data_x__1989 = contact.GetFixtureA().GetBody().GetUserData();
var data_y__1990 = contact.GetFixtureB().GetBody().GetUserData();

if(cljs.core.truth_(cljs.core.some.call(null,(function (p1__1983_SHARP_){
return cljs.core._EQ_.call(null,p1__1983_SHARP_,"﷐'ceiling");
}),cljs.core.Vector.fromArray([data_x__1989,data_y__1990]))))
...
return physicsGame.js_set.call(null,(new goog.global['Object']()),"﷐'PostSolve",physicsGame.empty_fn,"﷐'BeginContact",physicsGame.empty_fn,"﷐'EndContact",physicsGame.empty_fn,"﷐'PreSolve",(function (p1__1987_SHARP_,p2__1988_SHARP_){
return physicsGame.pre_solve.call(null,game,p1__1987_SHARP_,p2__1988_SHARP_);
}));
});
...
var gravity__1991 = physicsGame.v.call(null,0,10);
var doSleep__1992 = false;
var world__1993 = (new physicsGame.b2World(gravity__1991,doSleep__1992));

return world__1993;
});
physicsGame.create_game = (function create_game(canvas){
var twiceScale__1994 = cljs.core._STAR_.call(null,2,physicsGame.scale);

return physicsGame.init.call(null,physicsGame.set_contact_listener.call(null,cljs.core.atom.call(null,physicsGame.add_methods.call(null,cljs.core.ObjMap.fromObject(["﷐'center-x","﷐'center-y","﷐'world","﷐'canvas"],{"﷐'center-x":cljs.core._SLASH_.call(null,physicsGame.W,twiceScale__1994),"﷐'center-y":cljs.core._SLASH_.call(null,physicsGame.H,twiceScale__1994),"﷐'world":physicsGame.build_world.call(null),"﷐'canvas":canvas})))));
});
...
var shape__1995 = fixture.GetShape();
var transform__1996 = fixture.GetBody().GetTransform();

return cljs.core.not.call(null,shape__1995.TestPoint(transform__1996,vec));
});
physicsGame.delete_at = (function delete_at(game,x,y){
var mouse_vec__1997 = physicsGame.v.call(null,x,y);
var aabb__1998 = (new physicsGame.b2AABB());
var delta__1999 = 0.0010;
var callback__2001 = (function (f){
if(cljs.core.truth_((function (){var or__3576__auto____2000 = physicsGame.static_QMARK_.call(null,f);

if(cljs.core.truth_(or__3576__auto____2000))
{return or__3576__auto____2000;
} else
{return physicsGame.not_has_point_QMARK_.call(null,f,mouse_vec__1997);
}
})()))
{return true;
} else
...
aabb__1998.lowerBound.Set(cljs.core._.call(null,x,delta__1999),cljs.core._.call(null,y,delta__1999));
aabb__1998.upperBound.Set(cljs.core._PLUS_.call(null,x,delta__1999),cljs.core._PLUS_.call(null,y,delta__1999));
return cljs.core.deref.call(null,game).call(null,"﷐'world").QueryAABB(callback__2001,aabb__1998);
});
...
return physicsGame.each_body.call(null,game,(function (p1__2002_SHARP_){
if(cljs.core.truth_(physicsGame.static_body_QMARK_.call(null,p1__2002_SHARP_)))
{return null;
} else
{return cljs.core.deref.call(null,game).call(null,"﷐'world").DestroyBody(p1__2002_SHARP_);
}
}));
});
...
var game__2003 = physicsGame.create_game.call(null,physicsGame.get_canvas.call(null));

physicsGame.dom.call(null,"﷐'pause").click((function (){
return physicsGame.toggle_pause.call(null,game__2003);
}));
physicsGame.dom.call(null,"﷐'restart").click((function (){
return physicsGame.restart.call(null,game__2003);
}));
physicsGame.dom.call(null,"﷐'canvas").mousedown((function (e){
var o__2004 = physicsGame.dom.call(null,"﷐'canvas").offset();

physicsGame.on_click.call(null,game__2003,cljs.core._.call(null,e.pageX,o__2004.left),cljs.core._.call(null,e.pageY,o__2004.top));
return false;
}));
physicsGame.build_walls.call(null,game__2003);
return physicsGame.animate_world.call(null,game__2003);
});
