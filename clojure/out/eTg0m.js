...
physicsGame.js_set.call(null,body_def__1955,"﷐'userData",cljs.core.name.call(null,user_data),"﷐'type",physicsGame.b2Body.b2_staticBody);
...
var debug_draw__1968 = (new physicsGame.b2DebugDraw());

var G__1969__1970 = debug_draw__1968;

G__1969__1970.SetSprite(cljs.core.deref.call(null,game).call(null,"﷐'canvas").getContext("2d"));
G__1969__1970.SetDrawScale(physicsGame.scale);
G__1969__1970.SetLineThickness(1.0);
G__1969__1970.SetFlags(physicsGame.b2DebugDraw.e_shapeBit);
G__1969__1970;
cljs.core.deref.call(null,game).call(null,"﷐'world").SetDebugDraw(debug_draw__1968);
...
return goog.global['alert'].call(null,"on pre-solve");
});
physicsGame.contact_listener = (function contact_listener(game){
return physicsGame.js_set.call(null,(new goog.global['Object']()),"﷐'PostSolve",physicsGame.empty_fn,"﷐'BeginContact",physicsGame.empty_fn,"﷐'EndContact",physicsGame.empty_fn,"﷐'PreSolve",(function (p1__1971_SHARP_,p2__1972_SHARP_){
return physicsGame.pre_solve.call(null,game,p1__1971_SHARP_,p2__1972_SHARP_);
}));
});
physicsGame.set_contact_listener = (function set_contact_listener(game){
game.call(null,"﷐'world").SetContactListener(physicsGame.contact_listener.call(null,game));
return game;
});
physicsGame.build_world = (function build_world(){
var gravity__1973 = physicsGame.v.call(null,0,10);
var doSleep__1974 = false;
var world__1975 = (new physicsGame.b2World(gravity__1973,doSleep__1974));

return world__1975;
});
physicsGame.create_game = (function create_game(canvas){
var twiceScale__1976 = cljs.core._STAR_.call(null,2,physicsGame.scale);

return physicsGame.init.call(null,cljs.core.atom.call(null,physicsGame.set_contact_listener.call(null,physicsGame.add_methods.call(null,cljs.core.ObjMap.fromObject(["﷐'center-x","﷐'center-y","﷐'world","﷐'canvas"],{"﷐'center-x":cljs.core._SLASH_.call(null,physicsGame.W,twiceScale__1976),"﷐'center-y":cljs.core._SLASH_.call(null,physicsGame.H,twiceScale__1976),"﷐'world":physicsGame.build_world.call(null),"﷐'canvas":canvas})))));
});
...
var game__1977 = physicsGame.create_game.call(null,physicsGame.get_canvas.call(null));

physicsGame.dom.call(null,"﷐'pause").click((function (){
return physicsGame.toggle_pause.call(null,game__1977);
}));
physicsGame.build_walls.call(null,game__1977);
physicsGame.animate_world.call(null,game__1977);
return physicsGame.p.call(null,cljs.core.deref.call(null,game__1977));
});
