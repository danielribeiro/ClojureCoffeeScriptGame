...
physicsGame.get_body_at = (function get_body_at(game,x,y){
return 42;
});
physicsGame.delete_at = (function delete_at(game,x,y){
var body__1983 = physicsGame.get_body_at.call(null,game,x,y);

if(cljs.core.truth_(body__1983))
{physicsGame.atom_set.call(null,game,"﷐'to-destroy",cljs.core.conj.call(null,cljs.core.deref.call(null,game).call(null,"﷐'to-destroy"),body__1983));
} else
{}
...
var game__1984 = physicsGame.create_game.call(null,physicsGame.get_canvas.call(null));

physicsGame.dom.call(null,"﷐'pause").click((function (){
return physicsGame.toggle_pause.call(null,game__1984);
}));
physicsGame.dom.call(null,"﷐'canvas").mousedown((function (e){
var o__1985 = physicsGame.dom.call(null,"﷐'canvas").offset();

physicsGame.on_click.call(null,game__1984,cljs.core._.call(null,e.pageX,o__1985.left),cljs.core._.call(null,e.pageY,o__1985.top));
return false;
}));
physicsGame.build_walls.call(null,game__1984);
return physicsGame.animate_world.call(null,game__1984);
});
