...
physicsGame.wall.call(null,game,w__1960,dim__1962,w__1960,cljs.core._PLUS_.call(null,dim__1962,cljs.core._STAR_.call(null,2,h__1961)));
physicsGame.wall.call(null,game,dim__1962,h__1961,cljs.core._.call(null,dim__1962),h__1961);
return physicsGame.wall.call(null,game,dim__1962,h__1961,cljs.core._PLUS_.call(null,dim__1962,cljs.core._STAR_.call(null,2,w__1960)),h__1961);
});
physicsGame.tick = (function tick(game){
var w__1963 = game.call(null,"﷐'world");

w__1963.Step(1,cljs.core._SLASH_.call(null,1,30),10,10);
w__1963.DrawDebugData();
return w__1963.ClearForces();
});
physicsGame.animate_world = (function animate_world(game){
var debug_draw__1964 = (new physicsGame.b2DebugDraw());

var G__1965__1966 = debug_draw__1964;

G__1965__1966.SetSprite(game.call(null,"﷐'canvas").getContext("2d"));
G__1965__1966.SetDrawScale(physicsGame.scale);
G__1965__1966.SetLineThickness(1.0);
G__1965__1966.SetFlags(physicsGame.b2DebugDraw.e_shapeBit);
G__1965__1966;
game.call(null,"﷐'world").SetDebugDraw(debug_draw__1964);
...
var game__1967 = physicsGame.create_game.call(null,physicsGame.get_canvas.call(null));

physicsGame.build_walls.call(null,game__1967);
return physicsGame.animate_world.call(null,game__1967);
});
