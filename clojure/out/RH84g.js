...
return cljs.core.swap_BANG_.call(null,atom,(function (p1__1934_SHARP_){
...
var gravity__1949 = physicsGame.v.call(null,0,10);
var doSleep__1950 = false;
var twiceScale__1951 = cljs.core._STAR_.call(null,2,physicsGame.scale);

return physicsGame.init.call(null,cljs.core.atom.call(null,physicsGame.add_methods.call(null,cljs.core.ObjMap.fromObject(["﷐'center-x","﷐'center-y","﷐'world","﷐'canvas"],{"﷐'center-x":cljs.core._SLASH_.call(null,physicsGame.W,twiceScale__1951),"﷐'center-y":cljs.core._SLASH_.call(null,physicsGame.H,twiceScale__1951),"﷐'world":(new physicsGame.b2World(gravity__1949,doSleep__1950)),"﷐'canvas":canvas}))));
});
...
var create_fixture__1953 = (function (){
return create_fixture.call(null,null);
});
var create_fixture__1952 = (function (shape){
...
switch(arguments.length){
case  0 :
return create_fixture__1953.call(this);
case  1 :
return create_fixture__1952.call(this,shape);
}
throw('Invalid arity: ' + arguments.length);
};
...
var b__1955 = (new physicsGame.b2BodyDef());

physicsGame.js_set.call(null,b__1955,"﷐'type",physicsGame.b2Body.b2_dynamicBody);
b__1955.position.Set(x,y);
return b__1955;
});
physicsGame.create = (function create(game,body_def,fix_def){
var body__1956 = cljs.core.deref.call(null,game).call(null,"﷐'world").CreateBody(body_def);

body__1956.CreateFixture(fix_def);
return body__1956;
});
physicsGame.wall = (function() {
var wall = null;
var wall__1959 = (function (game,width,height,x,y){
return wall.call(null,game,width,height,x,y,null);
});
var wall__1960 = (function (game,width,height,x,y,user_data){
var fix_def__1957 = physicsGame.create_fixture.call(null,(new physicsGame.b2PolygonShape()));
var body_def__1958 = physicsGame.create_body.call(null,x,y);

fix_def__1957.shape.SetAsBox(width,height);
physicsGame.js_set.call(null,body_def__1958,"﷐'userData",cljs.core.name.call(null,user_data),"﷐'type",physicsGame.b2Body.b2_staticBody);
return physicsGame.create.call(null,game,body_def__1958,fix_def__1957);
});
wall = function(game,width,height,x,y,user_data){
switch(arguments.length){
case  5 :
return wall__1959.call(this,game,width,height,x,y);
case  6 :
return wall__1960.call(this,game,width,height,x,y,user_data);
}
throw('Invalid arity: ' + arguments.length);
};
return wall;
...
var w__1962 = cljs.core.deref.call(null,game).call(null,"﷐'center-x");
var h__1963 = cljs.core.deref.call(null,game).call(null,"﷐'center-y");
var dim__1964 = cljs.core._SLASH_.call(null,200,physicsGame.scale);

physicsGame.wall.call(null,game,w__1962,dim__1964,w__1962,cljs.core._.call(null,dim__1964),"﷐'ceiling");
physicsGame.wall.call(null,game,w__1962,dim__1964,w__1962,cljs.core._PLUS_.call(null,dim__1964,cljs.core._STAR_.call(null,2,h__1963)));
physicsGame.wall.call(null,game,dim__1964,h__1963,cljs.core._.call(null,dim__1964),h__1963);
return physicsGame.wall.call(null,game,dim__1964,h__1963,cljs.core._PLUS_.call(null,dim__1964,cljs.core._STAR_.call(null,2,w__1962)),h__1963);
});
physicsGame.random_body = (function random_body(x,y){
var b__1965 = physicsGame.create_body.call(null,x,y);
var vx__1966 = cljs.core._.call(null,cljs.core._STAR_.call(null,10,cljs.core.rand.call(null)),5);

return physicsGame.js_set.call(null,b__1965,"﷐'angle",cljs.core._STAR_.call(null,360,cljs.core.rand.call(null)),"﷐'linearVelocity",physicsGame.v.call(null,vx__1966,0),"﷐'angularVelocity",cljs.core._.call(null,cljs.core._STAR_.call(null,4,cljs.core.rand.call(null)),2));
});
...
return physicsGame.create_circle.call(null,game,randomX__1968,randomY__1967,cljs.core.inc.call(null,cljs.core.rand.call(null)));
});
...
var w__1970 = cljs.core.deref.call(null,game).call(null,"﷐'world");

physicsGame.maybe_create_element.call(null,game);
w__1970.Step(cljs.core._SLASH_.call(null,1,30),10,10);
w__1970.DrawDebugData();
return w__1970.ClearForces();
});
physicsGame.animate_world = (function animate_world(game){
var debug_draw__1971 = (new physicsGame.b2DebugDraw());

var G__1972__1973 = debug_draw__1971;

G__1972__1973.SetSprite(cljs.core.deref.call(null,game).call(null,"﷐'canvas").getContext("2d"));
G__1972__1973.SetDrawScale(physicsGame.scale);
G__1972__1973.SetLineThickness(1.0);
G__1972__1973.SetFlags(physicsGame.b2DebugDraw.e_shapeBit);
G__1972__1973;
cljs.core.deref.call(null,game).call(null,"﷐'world").SetDebugDraw(debug_draw__1971);
...
var game__1974 = physicsGame.create_game.call(null,physicsGame.get_canvas.call(null));

physicsGame.build_walls.call(null,game__1974);
return physicsGame.animate_world.call(null,game__1974);
});
