...
var gravity__1971 = physicsGame.v.call(null,0,10);
var doSleep__1972 = false;
var twiceScale__1973 = cljs.core._STAR_.call(null,2,physicsGame.scale);

return physicsGame.init.call(null,cljs.core.atom.call(null,physicsGame.add_methods.call(null,cljs.core.ObjMap.fromObject(["﷐'center-x","﷐'center-y","﷐'world","﷐'canvas"],{"﷐'center-x":cljs.core._SLASH_.call(null,physicsGame.W,twiceScale__1973),"﷐'center-y":cljs.core._SLASH_.call(null,physicsGame.H,twiceScale__1973),"﷐'world":(new physicsGame.b2World(gravity__1971,doSleep__1972)),"﷐'canvas":canvas}))));
});
...
if(cljs.core.truth_(cljs.core.not.call(null,"﷐'game-over".call(null,cljs.core.deref.call(null,game)),(function (){var new_paused__1974 = cljs.core.not.call(null,cljs.core.deref.call(null,game).call(null,"﷐'paused"));

physicsGame.atom_set.call(null,game,"﷐'paused",new_paused__1974);
...
var game__1975 = physicsGame.create_game.call(null,physicsGame.get_canvas.call(null));

physicsGame.dom.call(null,"﷐'pause").click((function (){
return physicsGame.toggle_pause.call(null,game__1975);
}));
physicsGame.build_walls.call(null,game__1975);
return physicsGame.animate_world.call(null,game__1975);
});
