...
if(cljs.core.truth_(cljs.core.not.call(null,"﷐'game-over".call(null,cljs.core.deref.call(null,game)),physicsGame.set_paused.call(null,game,physicsGame.not_paused_QMARK_.call(null,game)),physicsGame.update_pause_text.call(null,game))))
{return null;
} else
{return null;
}
...
var game__1999 = physicsGame.create_game.call(null,physicsGame.get_canvas.call(null));

physicsGame.dom.call(null,"﷐'pause").click((function (){
return physicsGame.toggle_pause.call(null,game__1999);
}));
physicsGame.dom.call(null,"﷐'canvas").mousedown((function (e){
var o__2000 = physicsGame.dom.call(null,"﷐'canvas").offset();

physicsGame.on_click.call(null,game__1999,cljs.core._.call(null,e.pageX,o__2000.left),cljs.core._.call(null,e.pageY,o__2000.top));
return false;
}));
physicsGame.build_walls.call(null,game__1999);
return physicsGame.animate_world.call(null,game__1999);
});
